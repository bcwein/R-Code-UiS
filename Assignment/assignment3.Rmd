...
We chose the mean vector that we found in assignment 2 problem 4 c for tuning 
the theta variable, the code and covariance matrix is borrowed from the tip
