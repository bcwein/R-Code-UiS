...
This is example follows the properties for a negative binomial distrobution.

We calculate the expected value in R

```{r}
#E(X) of random variable X that has a negative binomial distrobution.
f5 = function(x) dnbinom(x, size=1, prob=0.2)
# Calculate E(X)
f5(2)

# this can not be in R since it is a infinite series
```