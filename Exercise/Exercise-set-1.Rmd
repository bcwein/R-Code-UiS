...
This is example follows the properties for a negative binomial distribution.

Negative Binomial Distrobution has a infinite number of elements, since there is
