...
n <- 10
s <- 10000
mat <- matrix(rbinom(n*s, 1, c(0.7,0.95,0.95,0.95,0.99,0.99,0.92,0.92,0.92,0.7)), n, s)
p <- numeric(4)
...
b. By simulation nd the risk-weighted and the non risk-weighted expectation
for the total resource R

```{r}
sims <- 10000

n1 <- sum(triangle(sims, 2, 6, 4) / sims)
n2 <- sum(triangle(sims, 3, 11, 7) / sims)
n3 <- sum(triangle(sims, 2, 6, 4) / sims)
n4 <- sum(triangle(sims, 1, 9, 5) / sims)
n5 <- sum(triangle(sims, 8, 10, 9) / sims)
n6 <- sum(triangle(sims, 5, 9, 7) / sims)
n7 <- sum(triangle(sims, 2, 6, 4) / sims)
n8 <- sum(triangle(sims, 3, 5, 4) / sims)
n9 <- sum(triangle(sims, 8, 12, 10) / sims)
n10 <- sum(triangle(sims, 3, 7, 5) / sims)
...
d. By simulation nd an estimate of the accompanying standard deviation for the 
